...
set CommonCompilerFlags=-MTd -nologo -fp:fast -Gm- -GR- -EHa- -Zo -O2 -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4505 -wd4456 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Z7
